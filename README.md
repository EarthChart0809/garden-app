...
1. サインアップ画面からメールアドレス・パスワードを入力
![パスワード](image/signup.png)
2. 確認メールを送信
![確認メール](image/auth.png)
3. メール内の認証リンクをクリック
![認証リンク](image/mail.png)
4. アカウントが有効化される
5. ログイン可能になる
![ログイン](image/login_after.png)

**注意**
認証リンクは、サインアップを行ったブラウザと同じブラウザで開いてください。
