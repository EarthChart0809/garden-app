...
export default function SignUpPage() {
  ...
  async function signUp() {
    ...
    if (passwordStrength < 2) {
      alert(
        "パスワードが弱すぎます。8文字以上で英字・数字・記号を組み合わせてください。",
      );
      return;
    }
  ...
  return (
    <main className="mx-auto mt-20 max-w-md">
      ...
      <div className="space-y-4">
        ...
        <div>
          <div className="relative">
            ...
            <button
              ...
              onClick={() => setShowPassword((prev) => !prev)}
              aria-label={
                showPassword ? "確認パスワードを非表示" : "確認パスワードを表示"
              }
              className="absolute top-1/2 right-2 -translate-y-1/2 rounded p-1 text-gray-600 hover:text-gray-900"
            >
              <EyeIcon closed={showPassword} />
        ...
        <button
          onClick={signUp}
          className="w-full rounded bg-green-600 py-2 text-white disabled:cursor-not-allowed disabled:bg-green-300"
